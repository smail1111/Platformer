...
lv_3_screen = Screen([[
    ...
    M_Platform((160, 400), 20, 80, 20, "RL", 16, danger=True, color="red"),
    Platform((200, 500), 100, 20),
    Platform((400, 500), 100, 20),
    M_Platform((515, 380), 20, 80, -10, "UD", 8, danger=True, color="red"),
    Platform((650, 500), 100, 20),
    M_Platform((765, 380), 20, 80, -10, "UD", 8, danger=True, color="red"),
    M_Platform((800, 400), 20, 80, 20, "RL", 16, danger=True, color="red"),
    Platform((800, 500), 100, 20),
    Platform((950, 500), 100, 20),
    Platform((1100, 500), 100, 20),
],
    [Dino(dino_sheet_image, (50, 300))]])
...
lv_3_screen_2 = Screen([[
    ...
    Platform((800, 100), 100, 20),
    M_Platform((720, 500), 100, 100, 20, "UD", 10, True, danger=True, color="red"),
    M_Platform((1040, 500), 100, 100, 20, "UD", 10, True, danger=True, color="red"),
    M_Platform((400, 500), 100, 100, 20, "UD", 10, True, danger=True, color="red"),
],
    [Dino(dino_sheet_image, (50, 300))]])

lv_3_screen_3 = Screen([[
    Platform((800, 700), 100, 20),
],
    [Dino(dino_sheet_image, (1000, 600))]])
